...
public:
    ArbolBB(void(*otroPunteroAFuncion)(T)) {
        ...
        this->comparar = [](T a, T b)->int {return std::stoi(a->getDestinatario().getCelular()) - std::stoi(b->getDestinatario().getCelular()); };
        raiz = nullptr;
    }
    bool insertar(T e) {
    ...
    void BusquedaPorCelular(int a) {
        std::cout << "Existe en el arreglo 1-si 0-no";
        T aux = raiz->elemento;
        aux->getDestinatario().setCelular(std::to_string(a));
